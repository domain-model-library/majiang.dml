package dml.majiang.simulator.impl.xuezhandaodi.service;
...
import dml.majiang.specialrules.xuezhandaodi.entity.XuezhandaodiDaActionUpdater;
import dml.majiang.specialrules.xuezhandaodi.entity.XuezhandaodiGangActionUpdater;
import dml.majiang.specialrules.xuezhandaodi.entity.XuezhandaodiGuoActionUpdater;
import dml.majiang.specialrules.xuezhandaodi.entity.XuezhandaodiHuActionUpdater;

import java.util.ArrayList;
import java.util.List;

public class XuezhandaodiPlayService extends PlayService {
    ...
    protected DaActionUpdater createDaActionUpdater() {
        return new XuezhandaodiDaActionUpdater(new BiaozhunDaActionUpdater());
    }
    ...
    protected GangActionUpdater createGangActionUpdater() {
        return new XuezhandaodiGangActionUpdater(new BiaozhunGangActionUpdater());
    }
    ...
    protected HuActionUpdater createHuActionUpdater() {
        return new XuezhandaodiHuActionUpdater();
    }
    ...
    protected GuoActionUpdater createGuoActionUpdater() {
        return new XuezhandaodiGuoActionUpdater(new PlayerDaPaiOrXiajiaMoPaiGuoActionUpdater());
    }
